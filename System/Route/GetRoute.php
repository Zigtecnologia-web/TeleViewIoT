...
class GetRoute
{
    ...
    {
        // Check if the BACK_END_URL environment variable is set
        if (isset($_ENV['BACK_END_URL']) && !empty($backendUrl = $_ENV['BACK_END_URL'])) {
            return $backendUrl;
        }
        ...
        $host = trim($host, '/'); // Remove trailing slashes
     ...
     */
    public function generateControllerAndMethod()
    {
